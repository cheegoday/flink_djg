package com.djg.cdcDebeziumFormat;

import com.djg.utils.FileUtils;
...
public class DebeziumRetractDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String filePath = "/Users/djg/private/教程/大数据/flink/多易教育Flink/flink_djg/java/src/main/resources/djg.sql";
