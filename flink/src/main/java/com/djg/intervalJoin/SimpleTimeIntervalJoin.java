...
public class SimpleTimeIntervalJoin {
    public static void main(String[] args) throws Exception {
        ...
        Tuple2<StreamExecutionEnvironment, StreamTableEnvironment> envs = EnvUtil.getEnv(1, "blink", TimeCharacteristic.EventTime, CheckpointingMode.AT_LEAST_ONCE);
